...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hepunits-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10845&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hepunits-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hepunits` can be installed with:

```
conda install hepunits
```

It is possible to list all of the versions of `hepunits` available on your platform with:
